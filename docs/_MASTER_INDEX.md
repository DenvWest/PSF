...
| Voortgang · verdunnen, zijbalk-navigatie, Mijn Dag-koppeling (Opus prompt) | `cursors/claude-opus-voortgang-verdunning-conversiekaart-2026-07.md` |
| Voortgang → leefstijlprofiel → domeinen als één reis (Opus prompt) | `cursors/claude-opus-voortgang-leefstijlprofiel-doorstroom-prompt.md` |
