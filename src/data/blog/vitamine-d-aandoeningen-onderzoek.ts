...
export const vitamineDAandoeningenOnderzoekData: BlogArtikel = {
  ...
  secties: [
    ...
    },
    {
      ...
      tekst:
        "Wij vergelijken supplementen en ordenen leefstijl; diagnoses laten we aan de zorg. Wat we wél kunnen: laten zien welke claims op een etiket zijn toegestaan en welke niet — zie [EFSA-claims](/kennisbank/efsa-claims) — en met de [Voedingcheck](/intake/voeding) checken of je voeding al genoeg vitamine D levert, zodat je weet waar je begint. De brede gids: [energie na 30](/energie-na-40).",
    },
  ],
  kernpunten: [
