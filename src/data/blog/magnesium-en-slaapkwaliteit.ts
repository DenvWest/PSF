...
export const magnesiumEnSlaapkwaliteitData: BlogArtikel = {
  ...
  coverImageAlt: "Strak opgemaakt wit bed in een lichte slaapkamer",
  heroIntro:
  ...
  secties: [
    ...
    },
    {
      ...
      items: [
        "Pompoenpitten (30 g): circa 150 mg magnesium — een van de rijkste bronnen per gram.",
        "Amandelen (30 g): circa 80 mg. Een handvol als snack levert al een substantiële bijdrage.",
        "Spinazie, gekookt (100 g): circa 87 mg. Verse spinazie bevat minder door het hoge watergehalte.",
    ...
    {
      type: "opsomming",
      titel: "Per doel: welke vorm en welke dosering?",
      inleiding:
    ...
    {
      type: "opsomming",
      titel: "Waar let je op bij een supplement?",
      inleiding:
      ...
      items: [
        "Welke vorm(en) magnesium? Vermijd supplementen waarbij magnesiumoxide de enige of hoofdvorm is — de biologische beschikbaarheid is te laag voor effectieve suppletie.",
