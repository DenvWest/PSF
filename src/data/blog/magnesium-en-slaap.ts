...
export const magnesiumEnSlaapData: BlogArtikel = {
  ...
  secties: [
    ...
    },
    {
      ...
      tekst: "Drie praktische stappen: controleer of je supplement magnesium glycinaat of bisglycinaat bevat — niet oxide als hoofdvorm. Controleer het elementaire magnesiumgehalte per dagdosering en mik op 200–400 mg. Neem het consequent in, elke avond 30–60 minuten voor bed. Magnesium is één stuk van een groter plaatje. Slecht slapen na 40 heeft meerdere oorzaken — circadiaan ritme, cortisol, slaaphygiëne — die samen het verschil maken. Slecht slapen na 40? Het is niet wat je denkt. Lees de complete gids van oorzaak tot oplossing: [de volledige aanpak voor betere slaap na je 40e.](/slaap-verbeteren-na-40) Wil je weten welke supplementen bij jouw situatie passen? [Doe de gratis Leefstijlcheck](/intake) — 15 vragen, 3 minuten, direct een persoonlijk herstelplan.",
    },
    {
      type: "tekst",
      titel: "Disclaimer",
