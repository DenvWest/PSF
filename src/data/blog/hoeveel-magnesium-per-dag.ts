...
export const hoeveelMagnesiumPerDagData: BlogArtikel = {
  ...
  coverImageAlt: "Pompoenpitten in een kom — een magnesiumrijke portie uit voeding",
  heroIntro:
  ...
  secties: [
    ...
    },
    {
      ...
      tekst:
        "Een dosering bepalen heeft alleen zin als magnesium überhaupt de stof is die bij jouw klacht hoort. In de [supplementengids](/supplementen) staan alle stoffen die wij beoordelen naast elkaar, met per stof de onderzoeksdosis, de vorm en de onderbouwing — zodat je ziet of magnesium bovenaan jouw rij hoort of ergens halverwege. Weet je dat nog niet, dan laat de [check](/intake) zien of je voeding al genoeg magnesium levert.",
    },
  ],
  kernpunten: [
