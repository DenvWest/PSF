...
export const vitamineDSeizoenenJaarritmeData: BlogArtikel = {
  ...
  secties: [
    ...
    },
    {
      ...
      tekst:
        "Daglicht stuurt niet alleen vitamine D-aanmaak maar ook je slaap-waakritme, en in de winter verschuiven allebei. In de [Voedingcheck](/intake/voeding) zie je of je voeding in de wintermaanden genoeg vitamine D-bronnen bevat, zodat je weet of een supplement zin heeft. De bredere gids: [energie na 30](/energie-na-40).",
    },
  ],
  kernpunten: [
