...
export const vitamineDZonNederlandData: BlogArtikel = {
  ...
  secties: [
    ...
    },
    {
      ...
      tekst:
        "Daglicht doet meer dan vitamine D: het zet ook je [circadiaan ritme](/kennisbank/circadiaan-ritme) gelijk, wat direct doorwerkt in slaap en energie. In de [Voedingcheck](/intake/voeding) zie je of je voeding al genoeg vitamine D-bronnen bevat, zodat je weet of zon alleen genoeg is of dat een supplement zinvol is. De bredere gids: [energie na 30](/energie-na-40).",
    },
  ],
  kernpunten: [
