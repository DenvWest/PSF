...
export const vitamineDHogeDosesSocialMediaData: BlogArtikel = {
  ...
  coverImageAlt: "Smartphone met selfie op het scherm — social-media-context rond gezondheidsclaims",
  heroIntro:
  ...
  secties: [
    ...
    },
    {
      ...
      tekst:
        "Als vermoeidheid je aanleiding is om vitamine D te overwegen, is de kans groot dat slaap, stress of eiwitinname meer opleveren. De [Voedingcheck](/intake/voeding) laat zien of je eiwitinname en andere voeding al op peil zijn, zodat je gericht kiest in plaats van stapelt. Bredere context: [energie na 30](/energie-na-40).",
    },
  ],
  kernpunten: [
