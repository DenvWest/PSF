  ...
  secties: [
    {
      ...
      tekst:
        "Testosteron beïnvloedt spiermassa, botdichtheid, libido, stemming en het gevoel van vitaliteit. Het is geen enkele schakelaar voor vermoeidheid: slaap, schildklier, ijzer, [zink](/beste-zink) en [beste vitamine D-supplementen](/beste-vitamine-d) na meten, stress en depressie kunnen dezelfde symptomen geven. Daarom is ‘even testosteron slikken’ zonder diagnose geen oplossing — en kan het risico’s geven.",
    },
    {
      type: "opsomming",
