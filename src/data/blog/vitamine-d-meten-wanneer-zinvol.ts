...
export const vitamineDMetenWanneerZinvolData: BlogArtikel = {
  ...
  coverImageAlt: "Laboratoriumglaswerk in een lichte werkruimte, klaar voor een meting",
  heroIntro:
  ...
  secties: [
    ...
    },
    {
      ...
      tekst:
        "Een normale vitamine D-waarde bij aanhoudende vermoeidheid stuurt je naar de plek waar meestal meer te halen valt: slaapritme, stressbelasting, eiwitinname en beweging. De [Voedingcheck](/intake/voeding) laat zien of je eiwitinname en andere voedingsstoffen al op peil zijn. Het bredere verhaal staat in [energie na 30](/energie-na-40).",
    },
  ],
  kernpunten: [
  ...
  metaDescription: "Wanneer vitamine D laten meten zinvol is, wat een labwaarde zegt, en waarom een eenmalige prik geen seizoensritme vervangt.",
  keywords: [
    "vitamine d meten",
