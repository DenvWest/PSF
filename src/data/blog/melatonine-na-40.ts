...
export const melatonineNa40Data: BlogArtikel = {
  ...
  coverImageAlt: "Rode zonsondergang boven een stil landschap",
  heroIntro:
  ...
  secties: [
    ...
    },
    {
      ...
      items: [
        ...
        "Melatonine: tijdelijk en in microdosering: als je melatonine inzet, gebruik dan een dosis van 0,3 tot 0,5 mg — niet de standaard 3 mg van de drogist. En zie het als tijdelijk hulpmiddel bij een specifiek timing-probleem, niet als structurele oplossing. [Melatonine als supplement — wanneer wel en wanneer niet.](/supplementen/melatonine)",
      ],
    },
    {
      type: "tekst",
