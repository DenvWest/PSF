...
export const magnesiumEnStressData: BlogArtikel = {
  ...
  coverImageAlt: "Kop kruidenthee met jasmijnbloemen op een houten tafel",
  heroIntro:
  ...
  secties: [
    ...
    },
    {
      ...
      tekst:
        "Spanning, slecht slapen en een lage batterij lopen zelden los van elkaar, en juist bij aanhoudende stress loopt je magnesiumverlies op. De [Voedingcheck](/intake/voeding) laat in een paar minuten zien of je voeding dat verlies nog bijbeent. Wil je daarna zien welke stoffen bij het stressdomein horen en hoe sterk hun onderbouwing is, dan staan ze naast elkaar in de [supplementengids](/supplementen).",
    },
  ],
  kernpunten: [
