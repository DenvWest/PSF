...
export interface KennisbankTerm {
  ...
  /** Pad naar coverbeeld, bijv. `/images/kennisbank/<slug>.jpg`. Ontbreekt → thema-fallback. */
  coverImage?: string
...
Onderzoek gebruikt nog steeds uiteenlopende plantendelen, doses en extractprofielen — een “adaptogeen‑effect” is geen uniform farmacologisch blok. RCT‑resultaten zijn het meest overtuigend voor afgebakende preparaten (vooral sommige ashwagandha‑extracten), minder voor de hele categorie.`,
  ...
  },
  {
    ...
    coverImage: '/images/kennisbank/epa-dha-v2.jpg',
    coverImageAlt: "Gegrilde zalmfilet op een bord — bron van EPA en DHA",
    content: {
...
Voor de vraag of je überhaupt moet aanvullen telt eerst je bord: [omega-3 uit voeding](/blog/omega-3-uit-voeding-of-supplement). Wil je je status laten meten, lees dan [omega-3-index meten](/blog/omega-3-index-meten). Wat de grote hart-trials wel en niet lieten zien staat in [omega-3 en het hart](/blog/omega-3-en-hart-onderzoek), en de interactievraag bij antistolling in [omega-3 en medicijnen](/blog/omega-3-en-medicijnen). Praktische keuzehulp per vorm en dosering staat in de [supplementgids omega-3](/supplementen/omega-3); vergelijk producten op [/beste/omega-3-supplement](/beste/omega-3-supplement).`,
  ...
  },
  {
    ...
    coverImage: '/images/kennisbank/circadiaan-ritme.jpg',
    coverImageAlt: "Ochtendzon boven een rustig landschap",
    content: {
...
Na 30 wordt dit systeem gevoeliger voor verstoring. Blauw licht van schermen onderdrukt je melatonineproductie sterker, onregelmatige bedtijden verstoren het ritme sneller, en je cortisolcurve vlakt af — waardoor je 's ochtends trager op gang komt en 's avonds minder goed afschakelt.`,
...

  {
    ...
    coverImage: '/images/kennisbank/adh.jpg',
    coverImageAlt: "Glas water op een tafel bij zacht daglicht",
    content: {
...
Let op: "laboratorium getest" op een etiket zonder te vermelden welk lab is weinig waard. Transparante merken publiceren de naam van het testlab en maken certificaten beschikbaar op hun website.`,
  ...
  },
  {
    ...
    coverImage: '/images/kennisbank/slaaphygiene.jpg',
...
In de Leefstijlcheck telt verbinding mee als interventiedomein. Scoort het bij jou laag, begin dan niet met méér agenda-items, maar met één terugkerend moment — bellen, wandelen, sporten met dezelfde persoon. Herhaling bouwt de terugvalbasis, niet de grootte van je netwerk.`,
  ...
  },
  {
    ...
    coverImage: '/images/kennisbank/magnesiumvormen.jpg',
    coverImageAlt: "Groene bladgroenten en zaden op een licht werkblad",
    content: {
...
Diagnose hoort bij sportmedisch/zorgprofessional bij aanhoudende klachten; online checklists zijn geen vervanging.`,
  ...
  },
  {
    ...
    coverImage: '/images/kennisbank/vitamine-d.jpg',
    coverImageAlt: "Zonlicht op zee of strand bij helder weer",
    content: {
...
Lees verder: [vitamine D en energie](/blog/vitamine-d-en-energie), [tekort herkennen](/blog/vitamine-d-tekort-herkennen) en de keuzevraag [D3 met of zonder K2](/blog/vitamine-d-en-k2-samen). Praktische keuzehulp per vorm en dosering staat in de [supplementgids vitamine D](/supplementen/vitamine-d); vergelijk producten op [/beste/vitamine-d](/beste/vitamine-d). De Leefstijlcheck vraagt naar zonlicht (LIF_SUN).`,
    },
...
Belangrijker dan het innamemoment is de vraag of je het überhaupt nodig hebt: zie [vitamine D](/kennisbank/vitamine-d), [vitamine D meten](/blog/vitamine-d-meten-wanneer-zinvol) en de seizoenscontext in [vitamine D door het jaar heen](/blog/vitamine-d-seizoenen-jaarritme). Voor de keuze tussen D3 en D3+K2: [vitamine D en K2 samen](/blog/vitamine-d-en-k2-samen). Doseringsgrenzen staan in [hoge doses vitamine D](/blog/vitamine-d-hoge-doses-social-media).`,
  ...
  },
  {
    ...
    coverImage: '/images/kennisbank/oxidatieve-stress.jpg',
    coverImageAlt: "Berglandschap in helder, fris daglicht",
    content: {
