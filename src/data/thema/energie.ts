...
export const energieThema: ThemaPageData = {
  ...
  premiumCta: {
    ...
    subtitle:
      "De Leefstijlcheck analyseert je energie, slaap, stress, voeding, beweging en herstel in 15 vragen. Je krijgt een persoonlijk Herstelplan met concrete stappen.",
    features: [
      "15 vragen, 3 minuten",
