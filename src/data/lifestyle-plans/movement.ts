...
export const movementPlanTemplate: LifestylePlanTemplate = {
  ...
  recognition: {
    ...
    body:
      "Je traint nog wel, maar herstel duurt langer. Cardio lukt, maar kracht schiet erbij in. " +
  ...
  mechanism: {
    ...
    body:
      ...
      "Daarom win je hier het meeste met één thuis-oefening, daarna 2× per week full-body — niet met het zoveelste schema. " +
  ...
  phases: [
    {
      ...
      intro: {
        body:
          "Geen sportschool nodig — kies één oefening die je vandaag kunt doen. " +
    ...
    },
    {
      ...
      intro: {
        body:
          "Nu de basis staat, bouw je op naar 2× per week full-body kracht. " +
