...
export const testosteronGuide: GuideOptInData = {
  slug: "testosteron",
  ...
  recognition: {
    ...
    quotes: [
      "Ik heb minder drive dan vroeger.",
      "Herstel na sport duurt langer.",
      "Ik voel me minder scherp en minder gemotiveerd.",
      "Mijn lichaam verandert, ook al eet en beweeg ik hetzelfde.",
    ],
  },
  optIn: {
