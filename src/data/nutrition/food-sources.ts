...
const PROTEIN_SOURCES: readonly FoodSource[] = [
  ...
  },
  {
    ...
    source: usda("2646170", "Foundation"),
    nutrientValue: {
      value: 22.5,
      unit: "g",
      per: "100g",
      source: usda("2646170", "Foundation"),
      sourceNameNl: "Chicken, breast, boneless, skinless, raw",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    amount: 22.8,
    portionGroup: "leanMeat",
    source: usda("746759", "Foundation"),
    nutrientValue: {
      value: 22.8,
      unit: "g",
      per: "100g",
      source: usda("746759", "Foundation"),
      sourceNameNl: "Beef, loin, top loin steak, boneless, lip-on, separable lean only, trimmed to 1/8\" fat, choice, raw",
      observed: { min: 21.7, max: 23.9, median: 22.8, samples: 24 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    amount: 20.6,
    portionGroup: "leanMeat",
    source: usda("168312", "SR Legacy"),
    nutrientValue: {
      value: 20.6,
      unit: "g",
      per: "100g",
      source: usda("168312", "SR Legacy"),
      sourceNameNl: "Pork, fresh, loin, tenderloin, separable lean and fat, raw",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    amount: 16.1,
    portionGroup: "other",
    source: usda("2684444", "Foundation"),
    nutrientValue: {
      value: 16.1,
      unit: "g",
      per: "100g",
      source: usda("2684444", "Foundation"),
      sourceNameNl: "Fish, cod, Atlantic, wild caught, raw",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    amount: 22,
    portionGroup: "dairy",
    source: usda("328841", "Foundation"),
    nutrientValue: {
      value: 11,
      unit: "g",
      per: "100g",
      source: usda("328841", "Foundation"),
      sourceNameNl: "Cheese, cottage, lowfat, 2% milkfat",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    amount: 15.5,
    portionGroup: "dairy",
    source: usda("330137", "Foundation"),
    nutrientValue: {
      value: 10.3,
      unit: "g",
      per: "100g",
      source: usda("330137", "Foundation"),
      sourceNameNl: "Yogurt, Greek, plain, nonfat",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    source: usda("172421", "SR Legacy"),
    nutrientValue: {
      value: 9.02,
      unit: "g",
      per: "100g",
      source: usda("172421", "SR Legacy"),
      sourceNameNl: "Lentils, mature seeds, cooked, boiled, without salt",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    amount: 17.3,
    portionGroup: "other",
    source: usda("172475", "SR Legacy"),
    nutrientValue: {
      value: 17.3,
      unit: "g",
      per: "100g",
      source: usda("172475", "SR Legacy"),
      sourceNameNl: "Tofu, raw, firm, prepared with calcium sulfate",
    },
    verified: true,
    variability: "moderate",
    variabilityWhy:
  ...
  },
  {
    ...
    amount: 13,
    portionGroup: "legumes",
    source: usda("175194", "SR Legacy"),
    nutrientValue: {
      value: 8.67,
      unit: "g",
      per: "100g",
      source: usda("175194", "SR Legacy"),
      sourceNameNl: "Beans, kidney, red, mature seeds, cooked, boiled, without salt",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    amount: 12.6,
    portionGroup: "egg",
    source: usda("171287", "SR Legacy"),
    nutrientValue: {
      value: 12.6,
      unit: "g",
      per: "100g",
      source: usda("171287", "SR Legacy"),
      sourceNameNl: "Egg, whole, raw, fresh",
      observed: { min: 11.8, max: 13.1, samples: 12 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    amount: 11.1,
    portionGroup: "dairy",
    source: usda("172179", "SR Legacy"),
    nutrientValue: {
      value: 11.1,
      unit: "g",
      per: "100g",
      source: usda("172179", "SR Legacy"),
      sourceNameNl: "Cheese, cottage, creamed, large or small curd",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    source: usda("168915", "SR Legacy"),
    nutrientValue: {
      value: 13.5,
      unit: "g",
      per: "100g",
      source: usda("168915", "SR Legacy"),
      sourceNameNl: "Pasta, whole grain, 51% whole wheat, remaining unenriched semolina, dry",
      observed: { min: 13, max: 15, samples: 6 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    amount: 7.7,
    portionGroup: "legumes",
    source: usda("170017", "SR Legacy"),
    nutrientValue: {
      value: 5.15,
      unit: "g",
      per: "100g",
      source: usda("170017", "SR Legacy"),
      sourceNameNl: "Peas, green, frozen, cooked, boiled, drained, without salt",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    amount: 8.1,
    portionGroup: "wholegrain",
    source: usda("2346396", "Foundation"),
    nutrientValue: {
      value: 13.5,
      unit: "g",
      per: "100g",
      source: usda("2346396", "Foundation"),
      sourceNameNl: "Oats, whole grain, rolled, old fashioned",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      observed: { min: 19.4, max: 22.1, samples: 11 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      per: "100g",
      source: usda("174271", "SR Legacy"),
      sourceNameNl: "Soybeans, mature cooked, boiled, without salt",
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      observed: { min: 12.2, max: 15.2, samples: 3 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      observed: { min: 16.2, max: 17.4, samples: 4 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    nutrientValue: {
      ...
      observed: { min: 21.4, max: 22.7, samples: 6 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
...
const MAGNESIUM_SOURCES: readonly FoodSource[] = [
  {
    ...
    nutrientValue: {
      ...
      per: "100g",
      source: usda("170556", "SR Legacy"),
      sourceNameNl: "Seeds, pumpkin and squash seed kernels, dried",
      observed: { min: 579, max: 603, samples: 3 },
    },
    verified: true,
    variability: "moderate",
  ...
  },
  {
    ...
    seasonMonths: [4, 10],
    source: usda("168463", "SR Legacy"),
    nutrientValue: {
      value: 87,
      unit: "mg",
      per: "100g",
      source: usda("168463", "SR Legacy"),
      sourceNameNl: "Spinach, cooked, boiled, drained, without salt",
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      per: "100g",
      source: usda("173735", "SR Legacy"),
      sourceNameNl: "Beans, black, mature seeds, cooked, boiled, without salt",
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    amount: 96,
    portionGroup: "wholegrain",
    source: usda("168917", "SR Legacy"),
    nutrientValue: {
      value: 64,
      unit: "mg",
      per: "100g",
      source: usda("168917", "SR Legacy"),
      sourceNameNl: "Quinoa, cooked",
      observed: { min: 47, max: 88, samples: 3 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    amount: 81.3,
    portionGroup: "nuts",
    source: usda("170562", "SR Legacy"),
    nutrientValue: {
      value: 325,
      unit: "mg",
      per: "100g",
      source: usda("170562", "SR Legacy"),
      sourceNameNl: "Seeds, sunflower seed kernels, dried",
      observed: { min: 320, max: 330, samples: 2 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      source: usda("2346396", "Foundation"),
      sourceNameNl: "Oats, whole grain, rolled, old fashioned",
      observed: { min: 118, max: 140, median: 125, samples: 8 },
    },
    verified: true,
    variability: "low",
    bioavailability: "reduced",
  ...
  },
  {
    ...
    amount: 62.8,
    portionGroup: "nuts",
    source: usda("2515374", "Foundation"),
    nutrientValue: {
      value: 251,
      unit: "mg",
      per: "100g",
      source: usda("2515374", "Foundation"),
      sourceNameNl: "Nuts, cashew nuts, raw",
      observed: { min: 222, max: 265, median: 255, samples: 8 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    amount: 64.5,
    portionGroup: "nuts",
    source: usda("2346393", "Foundation"),
    nutrientValue: {
      value: 258,
      unit: "mg",
      per: "100g",
      source: usda("2346393", "Foundation"),
      sourceNameNl: "Nuts, almonds, whole, raw",
      observed: { min: 239, max: 271, median: 258, samples: 8 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    amount: 58.5,
    portionGroup: "wholegrain",
    source: usda("169704", "SR Legacy"),
    nutrientValue: {
      value: 39,
      unit: "mg",
      per: "100g",
      source: usda("169704", "SR Legacy"),
      sourceNameNl: "Rice, brown, long-grain, cooked (Includes foods for USDA's Food Distribution Program)",
      observed: { min: 32, max: 42, samples: 6 },
    },
    verified: true,
    variability: "low",
    bioavailability: "reduced",
  ...
  },
  {
    ...
    amount: 52.5,
    portionGroup: "wholegrain",
    source: usda("172688", "SR Legacy"),
    nutrientValue: {
      value: 75,
      unit: "mg",
      per: "100g",
      source: usda("172688", "SR Legacy"),
      sourceNameNl: "Bread, whole-wheat, commercially prepared",
      observed: { min: 66, max: 87, samples: 10 },
    },
    verified: true,
    variability: "low",
    bioavailability: "reduced",
  ...
  },
  {
    ...
    amount: 94.5,
    portionGroup: "legumes",
    source: usda("175203", "SR Legacy"),
    nutrientValue: {
      value: 63,
      unit: "mg",
      per: "100g",
      source: usda("175203", "SR Legacy"),
      sourceNameNl: "Beans, white, mature seeds, cooked, boiled, without salt",
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    amount: 33.6,
    portionGroup: "fruit",
    source: usda("1105314", "Foundation"),
    nutrientValue: {
      value: 28,
      unit: "mg",
      per: "100g",
      source: usda("1105314", "Foundation"),
      sourceNameNl: "Bananas, ripe and slightly ripe, raw",
      observed: { min: 26.9, max: 31.9, median: 27.4, samples: 6 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    amount: 27,
    portionGroup: "fruit",
    source: usda("746768", "Foundation"),
    nutrientValue: {
      value: 67.6,
      unit: "mg",
      per: "100g",
      source: usda("746768", "Foundation"),
      sourceNameNl: "Figs, dried, uncooked",
      observed: { min: 63.1, max: 73.4, median: 67.6, samples: 8 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  },
  {
    ...
    amount: 32.8,
    portionGroup: "fruit",
    source: usda("2710824", "Foundation"),
    nutrientValue: {
      value: 32.8,
      unit: "mg",
      per: "100g",
      source: usda("2710824", "Foundation"),
      sourceNameNl: "Avocado, Hass, peeled, raw",
      observed: { min: 29.2, max: 37.2, median: 33.3, samples: 8 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      observed: { min: 159, max: 170, samples: 4 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      observed: { min: 113, max: 127, samples: 3 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      observed: { min: 114, max: 246, samples: 3 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      observed: { min: 333, max: 387, samples: 8 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      source: usda("168874", "SR Legacy"),
      sourceNameNl: "Quinoa, uncooked",
      observed: { min: 190, max: 210, samples: 3 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
...
const ZINC_SOURCES: readonly FoodSource[] = [
  ...
  },
  {
    ...
    amount: 2.5,
    portionGroup: "nuts",
    source: usda("170148", "SR Legacy"),
    nutrientValue: {
      value: 9.9,
      unit: "mg",
      per: "100g",
      source: usda("170148", "SR Legacy"),
      sourceNameNl: "Seeds, hemp seed, hulled",
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      source: usda("170556", "SR Legacy"),
      sourceNameNl: "Seeds, pumpkin and squash seed kernels, dried",
      observed: { min: 7.45, max: 8.08, samples: 3 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      source: usda("168917", "SR Legacy"),
      sourceNameNl: "Quinoa, cooked",
      observed: { min: 0.85, max: 1.51, samples: 3 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      source: usda("171287", "SR Legacy"),
      sourceNameNl: "Egg, whole, raw, fresh",
      observed: { min: 1.24, max: 1.34, samples: 6 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      source: usda("2346396", "Foundation"),
      sourceNameNl: "Oats, whole grain, rolled, old fashioned",
      observed: { min: 2.33, max: 3.1, median: 2.77, samples: 8 },
    },
    verified: true,
    variability: "low",
    bioavailability: "reduced",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      source: usda("2515374", "Foundation"),
      sourceNameNl: "Nuts, cashew nuts, raw",
      observed: { min: 4.56, max: 5.44, median: 5.1, samples: 8 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      source: usda("172688", "SR Legacy"),
      sourceNameNl: "Bread, whole-wheat, commercially prepared",
      observed: { min: 1.57, max: 2.08, samples: 10 },
    },
    verified: true,
    variability: "low",
    bioavailability: "reduced",
  ...
  // ── USDA-import september 2026 (WebSearch-route; geen observed) ──
  {
    ...
    nutrientValue: {
      ...
      source: usda("170182", "SR Legacy"),
      sourceNameNl: "Nuts, pecans",
      observed: { min: 4.4, max: 4.8, samples: 3 },
    },
    verified: true,
    variability: "moderate",
    variabilityWhy: "Bodem en ras werken door in het mineraalgehalte.",
  ...
  },
  {
    ...
    nutrientValue: {
      ...
      source: usda("171060", "SR Legacy"),
      sourceNameNl: "Chicken, liver, all classes, raw",
      observed: { min: 2.56, max: 2.78, samples: 4 },
    },
    verified: true,
    variability: "low",
    bioavailability: "normal",
