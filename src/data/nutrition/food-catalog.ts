...
const NOTEN: readonly CatalogEntry[] = [
  ...
  f("hazelnoten", "Hazelnoten", "noten", "noten", P.noten, "hazelnoten", { ookIn: ["snacks"] }),
  f("pecannoten", "Pecannoten", "noten", "noten", P.noten, "pecannoten"),
  f("pistachenoten", "Pistachenoten", "noten", "noten", P.noten, "pistachenoten", { ookIn: ["snacks"] }),
  ...
  f("macadamia", "Macadamianoten", "noten", "noten", P.noten, "macadamia"),
  f("pinda", "Pinda's", "noten", "noten", P.noten, "pinda", { ookIn: ["snacks"], zoek: ["aardnoot", "olienootjes"] }),
...
const ZADEN: readonly CatalogEntry[] = [
  ...
  f("sesamzaad", "Sesamzaad", "zaden", "noten", [["eetlepel", 10]], "sesamzaad"),
  ...
  f("maanzaad", "Maanzaad", "zaden", "noten", [["eetlepel", 9]], "maanzaad"),
];
