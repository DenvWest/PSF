  ...
  return {
    messages: [
      ...
      },
      {
        role: "assistant",
        content:
          `Hallo! Ik help je met een korte leefstijlcheck. Ik stel je 18 vragen over slaap, energie, stress, voeding, beweging, herstel en leefstijl. Op basis van je antwoorden krijg je een persoonlijk ${INTAKE_DELIVERABLE.labelCapitalized}. Laten we beginnen!\n\nHoe beoordeel je je slaapkwaliteit? (1 = slecht, 4 = uitstekend)`,
      },
    ],
    collectedAnswers: {},
    collectedSymptoms: [],
