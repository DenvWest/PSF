export const INTAKE_DELIVERABLE = {
  ...
  subline: "16 vragen, 3 minuten — direct een persoonlijk leefstijloverzicht.",
  sublineShort: "16 vragen, 3 minuten — persoonlijk leefstijloverzicht.",
...
export const INTAKE_CTA = {
  ...
  blogSubline:
    "16 vragen · 3 min · gratis en anoniem — inzicht op 5 leefstijl-domeinen. Geen medische test.",
