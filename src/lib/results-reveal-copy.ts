...
export const REVEAL_COPY = {
  ...
  journeyOverview: "Overzicht",
  journeyPlan: "Plan",
  journeyDashboard: "Dashboard",
  firstStepEyebrow: "Je eerste stap",
  firstStepCtaHint: "Bewaar dit in je dashboard en volg je voortgang",
  lifestyleTrack: "Spoor A · Leefstijl",
  priorityPanelSummary: "Waar je begint",
  priorityHint: "zwakste bovenaan",
  ladderMoreCta: "Bekijk alle 6 pijlers in je dashboard →",
  secondaryLifestyleSummary: "Ook goed om vast te houden",
  lifestyleRoleKracht: "Blijf dit vasthouden",
  cta: "Bewaar dit en volg je voortgang →",
  ctaSubtext: "Log in en bewaar dit overzicht op één plek.",
  ctaPreviewLink: "Bekijk hoe je dashboard eruitziet",
  ctaPreviewLinkHide: "Verberg dashboard-preview",
