...
const PAGE_URL = "https://perfectsupplement.nl/beste-vitamine-d";

const OG_IMAGE_URL =
  "https://perfectsupplement.nl/images/producten/Vitaminstore-Super-D3.jpg";

export const metadata: Metadata = {
  title: vitamineDData.seoTitle,
  description: vitamineDData.seoDescription,
  alternates: { canonical: "/beste-vitamine-d" },
  openGraph: {
    title: vitamineDData.seoTitle,
    description: vitamineDData.seoDescription,
    type: "article",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Vitaminstore Super D3 — topkeuze in de vergelijking",
      },
    ],
  },
  twitter: {
...
export default function Page() {
  ...
  const breadcrumbSchema = buildBreadcrumbSchema([
    ...
    {
      name: "Supplementen",
      url: "https://perfectsupplement.nl/supplementen/vitamine-d",
    },
    { name: "Beste vitamine D", url: PAGE_URL },
  ]);
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
            ...
            <div className="mt-3 space-y-2">
              ...
              <Link
                ...
                className="block text-sm font-medium text-emerald-700 underline underline-offset-4"
              >
                Vitamine D combineren met magnesium? Bekijk de magnesiumvergelijking
              </Link>
              <Link
                href="/intake"
                className="block text-sm font-medium text-emerald-700 underline underline-offset-4"
