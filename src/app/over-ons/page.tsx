...
const bodyClass =
  "text-base md:text-lg leading-[1.75] text-stone-700";

const h2Class =
  "font-serif text-3xl md:text-4xl lg:text-5xl leading-tight max-w-3xl mb-8 text-balance text-stone-900";

const eyebrowClass =
  "block text-xs uppercase tracking-[0.2em] text-[#5A8F6A] mb-4";
        ...
        <Container>
          <article>
            <section className="py-24 md:py-32 lg:py-40">
              ...
              <hr className="mx-auto mt-24 max-w-3xl border-stone-200 md:mt-32" />
            </section>

            <section id={ABOUT_STORY.id} className="py-20 md:py-28">
            ...
            <hr className="mx-auto max-w-3xl border-stone-200" />

            <section id={ABOUT_INSIGHT.id} className="py-20 md:py-28">
              <div className="mx-auto max-w-3xl space-y-6">
            ...
            <section id={ABOUT_ORIGIN.id} className="py-20 md:py-28">
              <div className="mx-auto max-w-3xl space-y-6">
                ...
                <div className="space-y-6 pt-2">
                  ...
                  <blockquote className="text-2xl font-serif leading-snug text-stone-800 md:text-3xl border-l-2 border-[#5A8F6A] pl-6 py-2 max-w-2xl">
            ...
            <section id={ABOUT_WHAT_WE_DO.id} className="py-20 md:py-28">
              <div className="mx-auto max-w-3xl space-y-6">
                <span className={eyebrowClass}>Aanpak</span>
                <h2 className={`${h2Class} -mt-2`}>{ABOUT_WHAT_WE_DO.title}</h2>
                <p className={bodyClass}>
                  <span className="font-medium text-stone-800">
                    Eerst inzicht, dan pas aanvullen.
                  </span>{" "}
                  Met de gratis{" "}
                ...
                <div className="pt-8">
                  <h3 className="mb-10 font-serif text-2xl leading-tight text-stone-900 md:text-3xl">
            ...
            <section id={ABOUT_TRUST.id} className="py-20 md:py-28">
              <div className="mx-auto max-w-3xl space-y-6">
            ...
            <section id={ABOUT_CREDENTIALS.id} className="py-20 md:py-28">
              <div className="mx-auto max-w-3xl">
                <span className={eyebrowClass}>Wie schrijft dit</span>
                <h2 className={`${h2Class} -mt-2`}>{ABOUT_CREDENTIALS.title}</h2>
            ...
            <section className="py-20 md:py-28">
              <div className="mx-auto max-w-3xl">
                ...
                <p className={`${bodyClass} max-w-2xl`}>{ABOUT_CTA.description}</p>
                <p className="mt-8">
            ...
            <section className="pb-24 md:pb-32">
              <p className="mx-auto max-w-3xl text-base text-stone-500 md:text-lg">
                {ABOUT_CONTACT.text}{" "}
