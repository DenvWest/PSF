...
export default function AffiliateDisclosurePage() {
    return (
        ...
        >
            <section>
                <h2 className="text-xl font-semibold text-slate-900">1. Wat zijn affiliate links?</h2>
                <p className="mt-3">
            ...
            <section>
                <h2 className="text-xl font-semibold text-slate-900">2. Heeft dit invloed op de prijs?</h2>
                <p className="mt-3">
            ...
            <section>
                <h2 className="text-xl font-semibold text-slate-900">3. Waarom we affiliate links gebruiken</h2>
                <p className="mt-3">
            ...
            <section>
                <h2 className="text-xl font-semibold text-slate-900">4. Invloed op beoordelingen</h2>
                <p className="mt-3">
