...
export default function WaarLetJeOpBijOmega3Page() {
    return (
        <main className="bg-white text-slate-900">
            ...
            <section className="border-t border-slate-100 py-12 md:py-16">
                <Container>
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 text-base leading-7 text-slate-600">{epaSection.intro}</p>
            ...
            <section className="border-t border-slate-100 py-12 md:py-16">
                <Container>
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 text-base leading-7 text-slate-600">{doseringSection.intro}</p>
                        <ul className="mt-6 space-y-3 text-sm leading-6 text-slate-600">
            ...
            <section className="border-t border-slate-100 py-12 md:py-16">
                <Container>
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 text-base leading-7 text-slate-600">{prijsSection.intro}</p>
                        <ul className="mt-6 space-y-3 text-sm leading-6 text-slate-600">
            ...
            <section className="border-t border-slate-100 py-12 md:py-16">
                <Container>
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 text-base leading-7 text-slate-600">{capsulesSection.intro}</p>
                        <ul className="mt-6 space-y-3 text-sm leading-6 text-slate-600">
            ...
            <section className="border-t border-slate-100 py-12 md:py-16">
                <Container>
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-4 text-base leading-7 text-slate-600">{transparantieSection.intro}</p>
                        <ul className="mt-6 space-y-3 text-sm leading-6 text-slate-600">
            ...
            <section className="border-t border-slate-100 py-12 md:py-16">
                <Container>
                    <div className="max-w-3xl rounded-2xl border border-slate-200 bg-slate-50 px-6 py-8">
                        <p className="text-xs font-semibold uppercase tracking-[0.16em] text-green-700">
                            Methodologie
                        </p>
                        ...
                        <Link
                            href="/methodologie"
                            className="mt-5 inline-flex items-center text-sm font-medium text-green-700 underline-offset-4 hover:underline"
                        >
            ...
            <section className="py-6">
                <Container>
                    <div className="rounded-2xl border border-green-100 bg-green-50 px-6 py-5">
                        ...
                        <Link
                            href="/beste-omega-3-supplement"
                            className="mt-4 inline-flex items-center rounded-xl bg-green-700 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-green-800"
                        >
                            Bekijk beste omega&nbsp;3 supplementen →
                        </Link>
                    </div>
            ...
            >
                <div className="grid gap-4 md:grid-cols-2">
                    {mistakes.map((mistake) => (
                        ...
                        >
                            <p className="text-sm leading-6 text-slate-600">{mistake}</p>
                        </div>
                    ))}
                </div>
            ...
            {/* 11. Afsluitende CTA */}
            <section className="border-t border-slate-100 py-16 md:py-20">
                <Container>
