  ...
  return (
    ...
    >
      ...
      <p className="mt-5 text-[13.5px] leading-[1.55] text-[#9DB3A6]">
        Wil je weten waar jij staat op slaap, stress en energie? Je zes scores
        en aanbevelingen wonen in je dashboard — niet op deze pagina.
      </p>
      <div className="mt-5 flex flex-col gap-3 sm:flex-row">
        ...
        <Link
          href="/dashboard"
          onClick={() =>
            trackEvent("inzichten_hub_cta_click", { destination: "dashboard" })
          }
