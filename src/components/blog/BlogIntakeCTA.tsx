...
import { VOEDINGCHECK_CTA } from "@/lib/voedingcheck-facts";
...
export default function BlogIntakeCTA({
  ...
  const headline = isClosing
    ? VOEDINGCHECK_CTA.blogClosingHeadline
    : VOEDINGCHECK_CTA.blogHeadline;
  const subline = isClosing
    ? VOEDINGCHECK_CTA.blogClosingSubline
    : VOEDINGCHECK_CTA.blogSubline;
