    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="rounded-2xl border border-white/8 bg-white/[0.02] px-4 py-3.5">
        {stof ? (
          ...
          <p className="m-0 text-[13px] text-[#7E8C82]">
            Nog niets geregistreerd dat {label.toLowerCase()} levert.
          </p>
        )}
      </div>
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          disabled={busy}
          onClick={onVoegToe}
          className="cursor-pointer whitespace-nowrap rounded-lg border border-white/15 bg-white/[0.03] px-3 py-1.5 text-[12px] font-semibold text-[#9FB0A6] transition-colors hover:border-[#5A8F6A] hover:text-[#9CC5A9] disabled:opacity-50"
        >
          + Voeg toe
        </button>
      </div>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="shrink-0 cursor-pointer rounded px-1 text-[14px] leading-none text-[#6F8177] transition-colors hover:text-[#F1EFE8] disabled:opacity-40"
                >
                  &times;
                </button>
              </li>
