...
export default function MovementTodayHero({
  ...
  const resetChoice = () => {
    ...
    setTrainingGateView("question");
    setTrainingGateCleared(false);
    // Alleen wissen wat bestaat: wie de lijst heropent zonder vandaag iets te
    // hebben vastgelegd, laat geen keuze achter en dus ook geen wis-event.
    if (persistedKindRef.current != null) {
      persistChoice(null);
    }
  };
