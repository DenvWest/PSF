...
export default function DashboardPreviewMockup() {
  return (
    <section aria-labelledby="dashboard-preview" className="mb-10">
      ...
      <div className="overflow-hidden rounded-2xl border border-stone-200 bg-stone-900 shadow-lg">
        ...
        <div className="overflow-x-auto bg-[#0f1c10] px-3 pt-3">
          <nav
        ...
        <div className="space-y-3 bg-[#1a2e1c] p-4 md:p-5">
