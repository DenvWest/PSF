  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-[92rem] px-5 py-28 sm:px-8 sm:py-36 lg:px-12 lg:py-44">
        ...
        >
          <p className="font-sans text-[0.6875rem] font-medium uppercase tracking-[0.38em] text-[var(--ps-muted)] sm:text-xs">
            Supplementen · kennis eerst
          </p>
          <h1
            id="hero-heading"
            className="font-display mt-10 max-w-[min(100%,36rem)] text-[clamp(2.5rem,9vw,5.5rem)] font-light leading-[1.02] tracking-[-0.045em] text-[var(--ps-ink)] sm:mt-12"
          >
            Omega-3 en magnesium, helder uitgelegd.
          </h1>
          <p className="mt-12 max-w-2xl font-sans text-xl font-light leading-[1.65] text-[var(--ps-body)] sm:mt-14 sm:text-[1.35rem] sm:leading-relaxed md:max-w-2xl md:text-[1.4rem]">
