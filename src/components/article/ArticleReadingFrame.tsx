...
export default function ArticleReadingFrame({
  ...
  return (
    <div className={`flex w-full min-w-0 flex-col lg:flex-row ${READING_ROW_GAP_CLASS}`}>
      <aside className={`${READING_TOC_COL_CLASS} hidden min-h-0 self-stretch lg:block`}>
